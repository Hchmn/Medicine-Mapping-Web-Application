...
<head>
	<meta charset="UTF-8">
    <meta name="google-site-verification" content="JoXGBuXvAZkVOlVayVYojZ2I4qWU0DI_5mh1KNpKcPY" />
...
// check url
  window.onload = function(){
      ...
      var isAdmin = (url.localeCompare("http://admin.med-mapping.com/") == 0)? true:false;

      if(isAdmin){
          window.location.replace("https://med-mapping.com/login");
      }
  }
