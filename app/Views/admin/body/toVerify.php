...
<body class="h-100 overflow-hidden">
  ...
  <div class="border h-100 d-flex flex-row">
    ...
    <div class="border col-3 p-4 sidemenu">
      ...
      <div class="border mb-2">
        <a href="<?php echo base_url(); ?>/admin/pharmacy/to_verify" class="btn btn-outline-secondary w-100 d-flex align-items-center active" style="height:55px;">
          To verify
        </a>
      </div>
      <hr>
    ...
    <div class="border col">
      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          <?php
            foreach ($notVerifiedPharmacy as $key => $value) {
              $id = $value['ID'];
              $name = $value['NAME'];
              ?>
              <tr>
