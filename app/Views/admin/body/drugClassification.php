<body class="h-100">
  ...
  <div class="h-100 d-flex flex-row">
    ...
    <div class="col-3 p-4 sidemenu">
      ...
      <div class="border mb-2">
        <a href="<?php echo base_url(); ?>/admin/medicine/drug_classification" class="active btn btn-outline-secondary w-100 d-flex align-items-center  justify-content-between" style="height:55px;">
          Drug classification
        </a>
      </div>
      <div class="border mb-2">
    ...
    <div class="col">
      ...
      <div class="pt-3 pb-3 pe-3 d-flex justify-content-between">
        <button type="button" name="button" class="btn btn-primary" style="width:10%;" data-bs-toggle="modal" data-bs-target="#addClassification">Add</button>
        <div class="">
          <input type="text" name="" value="" class="form-control" placeholder="Search" id="search">
        </div>
      </div>
      ...
      <table class="table table-striped table-hover" id="medicineFormTable">
        <thead>
          <tr>
            ...
            <th scope="col">General Classification</th>
          </tr>
        </thead>
        <tbody id="tableBody">
          <?php
          foreach ($classifications as $key => $value) {
            $id = $value['DRUG_CLASSIFICATION_ID'];
            $name = $value['DRUG_CLASSIFICATION_NAME'];
            $genName = $value['GENERAL_CLASSIFICATION_NAME'];
            ?>
            <tr>
              <td scope="row"><?php echo "$id"; ?></td>
              <td scope=""><?php echo "$name"; ?></td>
              <td scope=""><?php echo "$genName"; ?></td>
            </tr>
            <?php
          }
           ?>
  ...
  <!-- Modal -->
  <div class="modal fade" id="addClassification" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalLabel">Drug Classification</h5>
          <button type="button" class="btn-close modalClose" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

          <!-- Modal body -->
          <div class="modal-body">
            <form class="" action="" method="" id="addDrugClassificationForm">
                <!-- name -->
                <div class="mb-3 row">
                ...
                <!-- general -->
                <div class="mb-3 row">
                  <label for="" class="col-sm-3 col-form-label">General Classification</label>
                  <div class="col-sm-9">
                    <select class="form-select" name="generalClassification" required>
                      <option value="">None</option>
                      <?php
                      foreach ($classifications as $key => $value) {
                        $id = $value['GENERAL_CLASSIFICATION_ID'];
                        $name = $value['GENERAL_CLASSIFICATION_NAME'];
                        ?>
...
<script src="<?php echo base_url(); ?>/assets/js/adminDrugClassification.js" charset="utf-8"></script>
